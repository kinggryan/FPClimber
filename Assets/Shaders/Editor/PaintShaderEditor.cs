...
public class PaintShaderEditor: MaterialEditor {
	...
	public override void OnInspectorGUI ()
	{
		...
		if (!props[0].hasMixedValue )
		{
			if( props[0].floatValue == 1)
			{
					...
					SetShader(Shader.Find("PaintShader/Outline"));
					props = MaterialEditor.GetMaterialProperties(targets);
			...
			{
				SetShader(Shader.Find("PaintShader/Base"));
				props = MaterialEditor.GetMaterialProperties(targets);
		...
		if(props[4].floatValue == 1)
		{
            ...
            ShaderProperty(props[17], "Fade To Color");
		}
