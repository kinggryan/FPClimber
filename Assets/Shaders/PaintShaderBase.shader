...
#pragma exclude_renderers d3d11 xbox360
                ...
                v2f vert (appdata_base0 v)
                {
                    ...
                    o.mypos = mul ( UNITY_MATRIX_MVP, v.vertex );
                ...
                fixed4 frag (v2f i) : COLOR
                {
                    ...
                    float3 height = i.mypos.y;//150; //i.pos.xyz; //150;//i.pos.xyz.y;
                    float colorMod = height.y / topHeight;
                    colorMod = clamp(colorMod,0,1);
					fixed4 toonShade = tex2D( _ToonShade, i.uvn )*((colorMod * _FadeToColor) + ((1-colorMod)*_Color));
					#else
